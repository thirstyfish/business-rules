(function($) {
  ...
  ConditionsBuilder.prototype = {
    ...
    buildConditional: function(ruleData) {
      ...
      selectWrapper.append($("<span>", {text: "When"}));
      var select = $("<select>", {"class": "strategy form-control all-any-none"});
      ...
      selectWrapper.append($("<span>", {text: "of the following conditions are met:"}));
  ...
  function getFieldSelect(fields, ruleData) {
    var select = $("<select>", {"class": "strategy form-control field"});
  ...
  function getOperatorSelect() {
    var select = $("<select>", {"class": "strategy form-control operator"});
  ...
  function onOperatorSelectChange(e) {
    ...
    switch(option.data("fieldType")) {
      case "none": 
        ...
        break;
      case "text":
        $this.after($("<input>", {"type": "text", "class": "strategy form-control value"}));
        break;
      case "textarea":
        $this.after($("<textarea>", {"class": "strategy form-control value"}));
      case "select":
        var select = $("<select>", {"class": "strategy form-control value"});
