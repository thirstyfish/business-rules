(function($) {
  ...
  ActionsBuilder.prototype = {
    ...
    buildAction: function(data) {
      ...
      var select = $("<select>", {"class": "strategy form-control action-select", "name": "action-select"});
    ...
    buildField: function(field) {
      ...
      if(field.fieldType == "select") {
        var label = $("<label>", {"text": field.label});
        var select = $("<select>", {"class": "strategy form-control", "name": field.name});
        ...
        var input = $("<input>", {"type": "text", "class": "strategy form-control", "name": field.name});
        div.append(input);
      }
      else if(field.fieldType == "textarea") {
        var id = "textarea-" + Math.floor(Math.random() * 100000);
        var area = $("<textarea>", {"class": "strategy form-control", "name": field.name, "id": id});
        div.append(area);
      }
